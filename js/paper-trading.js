...
async function renderPaperTrading() {
    ...
    for (let index = 0; index < positions.length; index++) {
        ...
        positionHtml += `<div class="bg-dark-card border border-dark-border rounded-xl p-3 space-y-2.5">
            ...
            <div class="flex justify-end border-t border-dark-border/60 pt-2"><button data-paper-symbol="${position.symbol}" data-paper-side="SELL" class="text-xs text-red-400"><i class="fas fa-minus-circle mr-1"></i>Bán vị thế</button></div>
        </div>`;
    }
